...
# NetworkBuilder class is composed of the various layers of the nueral network

class NetworkBuilder:
    def __init__self(self):
        pass

# Convolution Layer detects patterns in input layer
...
# Pooling layer reduces image size by sampling significant patterns detected from the input layer for quicker processing
...
# The activation layer is a way of interpreting input data to compute a probability between 0 and 1 using three
# differently curved functions to handle a variety of input
...
# The flatten layer will take the output info, expressed in 3D via pixel positions and values, and  condense that
# information to a 1D array
...
# Link all of the layers together
